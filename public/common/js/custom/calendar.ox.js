var calendarService = (function() {
    ...
    var getListAppointments = function(passedData) {
        ...
        if (shouldUseMocks) {
            ...
            var getListAppointmentsPromise = $.ajax({
                method: 'POST',
                crossDomain: true,
                url: baseApiUrl + 'calendarservice/allcalendar',
    ...
    var getSearchAppointments = function(passedData) {
        self.calendarData = [];
        if (shouldUseMocks) {
            var testingArray = getCalendarFieldNamesArray();
            console.log(testingArray);
            ...
            if(passedData.content) {
                requestData.searchString = passedData.content;
            }
            var getListAppointmentsPromise = $.ajax({
                method: 'POST',
                crossDomain: true,
                url: baseApiUrl + 'calendarservice/searchcalendar',
                data: JSON.stringify(requestData),
                dataType: "json",
                contentType : "application/json",
                success:function(data,textStatus,request) {
    ...
    return {
        ...
        getUserId: getUserId,
        getSearchAppointments: getSearchAppointments
    }
